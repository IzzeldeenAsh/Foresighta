...
<br><br>Build your ideal team from a pool of expert consultants and execute a tailored project plan to achieve your objectives.
    ...
    INSIGHTER_WIZARD: {
      ...
      EXPERIENCE_INVALID: "Please enter a valid number of years (0-80).",
  ...
  `,
    ...
    GENERATE_ABSTRACT: "Summary",
    SHARE: "Share",
    ADD_KNOWLEDGE_INFO: "Details",
    ADD_DOCUMENTS: "Upload",
    ...
    "CONSULTING_SCHEDULE": {
      ...
      "ACTIVE_DAYS_COUNT": "{{active}} of {{total}} active",
      "EXCEPTION_DAYS": "Exception Days",
      "TIME": "Time",
      "ONLINE": "Online",
      "ON_SITE": "On Site",
      "ONLINE_RATE": "Online rate",
      "ON_SITE_RATE": "On-site rate",
      "ONLINE_RATE_MIN_ERROR": "The minimum online rate is $10",
      "ON_SITE_RATE_MIN_ERROR": "The minimum on-site rate is $10",
      "PLACE_REQUIRED": "Select at least one of Online / On Site",
      "PHYSICAL_LOCATION": "Physical Location",
      "PHYSICAL_LOCATION_HELP": "This address is shown to clients who select an on-site session.",
