export const locale = {
  ...
  data: {
    ...
    INSIGHTER_WIZARD: {
      ...
      EXPERIENCE_INVALID: "يرجى إدخال عدد سنوات صحيح (0-80).",
    ...
    "CONSULTING_SCHEDULE": {
      ...
      "ACTIVE_DAYS_COUNT": "{{active}} من أصل {{total}} مفعلة",
      "EXCEPTION_DAYS": "المواعيد المستثناة",
      "TIME": "الوقت",
      "ONLINE": "عن بُعد",
      "ON_SITE": "حضورياً",
      "ONLINE_RATE": "سعر الجلسة عن بُعد",
      "ON_SITE_RATE": "سعر الجلسة الحضورية",
      "ONLINE_RATE_MIN_ERROR": "الحد الأدنى لسعر الجلسة عن بُعد هو 10$",
      "ON_SITE_RATE_MIN_ERROR": "الحد الأدنى لسعر الجلسة الحضورية هو 10$",
      "PLACE_REQUIRED": "اختر واحداً على الأقل من: عن بُعد / حضورياً",
      "PHYSICAL_LOCATION": "الموقع الحضوري",
      "PHYSICAL_LOCATION_HELP": "يظهر هذا العنوان للعملاء الذين يختارون جلسة حضورية.",
