...
export class IsicCodesService {
  private apiUrl = `${environment.apiBaseUrl}/common/setting/isic-code/tree-list`;
  private apiList = `${environment.apiBaseUrl}/common/setting/isic-code/list`
  ...
  getIsicCodesTreeParent(): Observable<any[]> {
    ...
    this.setLoading(true);
    return this.http.get<any>(`${environment.apiBaseUrl}/common/setting/isic-code/tree/parent`, { headers }).pipe(
  ...
  createIsicCode(isicCode: any): Observable<IsicCode> {
    ...
    this.setLoading(true);
    return this.http.post<IsicCode>(`${environment.apiBaseUrl}/admin/setting/isic-code`, isicCode, { headers }).pipe(
  ...
  updateIsicCode(id: number, isicCode: any): Observable<IsicCode> {
    ...
    this.setLoading(true);
    return this.http.put<IsicCode>(`${environment.apiBaseUrl}/admin/setting/isic-code/${id}`, isicCode, { headers }).pipe(
      catchError(this.handleError),
      finalize(() => this.setLoading(false))
    );
  }
  ...
  deleteIsicCode(id: number): Observable<any> {
    ...
    this.setLoading(true);
    return this.http.delete<any>(`${environment.apiBaseUrl}/admin/setting/isic-code/${id}`, { headers }).pipe(
      catchError(this.handleError),
      finalize(() => this.setLoading(false))
    );
  }
